    ...
    <Accordion type="single" collapsible>
      <AccordionItem value="item-1">
        <AccordionTrigger
          ...
          className=" hover:bg-brand-100 [&[data-state=open]]:rounded-b-none rounded-xl p-5 hover:no-underline  bg-white border border-white text-md md:text-xl text-gray-950 font-semibold"
        >
