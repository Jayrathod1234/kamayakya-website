    ...
    <div className={`group/team`}>
      ...
      >
        <button
          ...
          className={` pointer-events-auto border border-brand-300 transition-all duration-300 flex items-center justify-center  ${
      ...
      >
        <button
          onClick={() => setDisplay((prev) => !prev)}
          className={` ${
            display ? " rotate-0" : " rotate-45"
          }  flex items-center justify-center transition-all duration-300 h-[50px] w-[50px] rounded-xl absolute bg-white top-[9px] right-[9px] z-10 shadow`}
        >
