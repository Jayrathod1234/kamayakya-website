                  ...
                  >
                    ...
                    >
                      ...
                      <Tooltip title="Please become a member to watch this video.">
                        <img
                          src="/assets/play.gif"
                          alt=""
                          style={{ width: 24, filter: "blur(2px)" }}
                        />
                      </Tooltip>
                    </Box>
                    ...
                    <Box sx={{ p: 2 }}>
                      <Box sx={{ display: "flex", gap: 1 }}>
                        ...
                        >
                          ...
                          <Typography
                            variant="caption"
                            sx={{ fontWeight: "bold", color: "#A3651A" }}
                          >
                            Air Conditioners
                          </Typography>
                        </Box>
                        ...
                        >
                          ...
                          <Typography
                            variant="caption"
                            sx={{ fontWeight: "bold", color: "#667085" }}
                          >
                            MCap:
                            <Box
                              sx={{
                    ...
                    <Box sx={{ px: 2, pb: 2 }}>
                      <Box sx={{ p: 1, borderRadius: 1, bgcolor: "#f7f8fa" }}>
                        ...
                        >
                          <Tooltip
                            title="Upside Left means how much the stock price could rise from its current level."
                            arrow
                          >
                            <InfoIcon />
                          </Tooltip>
