...
const FilterCarousel = () => {
  ...
  const [chips, setChips] = useState([
    { label: "Most Recent", id: 1, originalIndex: 0, icon: "/assets/watch.svg" },
    { label: "Value Pick", id: 2, originalIndex: 1, icon: "/assets/Pricing.svg" },
    { label: "Market Leadership", id: 3, originalIndex: 2, icon: "/assets/leader.svg" },
    { label: "Thematic Stories", id: 4, originalIndex: 3, icon: "/assets/bulb.svg" },
    { label: "Chemicals", id: 5, originalIndex: 4, icon: "/assets/chamical.svg" },
                ...
                <Chip
                  ...
                  avatar={
                    <img
                      ...
                      style={{
                        width: 14,
                        height: 14,
                        filter: selectedChips.includes(chip.id) ? "invert(1)" : "none",
                      }}
                    />
                  }
                  label={chip.label}
                  ...
                  sx={{
                    ...
                    backgroundColor: selectedChips.includes(chip.id)
                      ? "#125b54"
                      : "white",
                    color: selectedChips.includes(chip.id) ? "white" : "inherit",
                    "&:hover": {
                      backgroundColor: selectedChips.includes(chip.id)
                        ? "#125b54"
                        : "#e7f8f8",
