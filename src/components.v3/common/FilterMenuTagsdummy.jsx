  ...
  return (
    ...
    {clickedButtons.map((button) => (
      <div key={button.id} className="w-auto ">
        <button
          className={`group relative px-5 py-[10px] flex items-center  justify-between w-full shadow-md border-[#E4E7EC]  border rounded transition-all duration-500 ${clickedButtons.length > 0
