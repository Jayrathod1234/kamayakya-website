...
function StockCard({
  ...
  return (
    <>
      {/* new stock card  */}
      <div
        className={`relative max-w-[406px]  w-[406px] main_card_carousel ${className}`}
      >
        <div
            ...
            {is_blur ? (
              <div className="pt-[20px] px-[20px] flex gap-[36px] items-center justify-between">
                <div className="p-1 gap-2 flex items-center">
                  ...
                  <div className="h-5 bg-[#EDF0F5] rounded-[20px] sm:min-w-[281px] sm:w-full min-w-[125px] w-full"></div>
                </div>
