        ...
        <div className="justify-center items-center flex ">
          <div>
            <Button
              ...
              variant={"default"}
              className="rounded-full md:h-[52px] md:w-[52px] h-6 w-6 p-2 group hover:scale-[0.95] hover:bg-[#0B3A36] transition-all duration-300 ease-in-out absolute top-[45%] z-[9] left-5"
            >
        ...
        <div className="justify-center items-center flex">
          <div>
            <Button
              ...
              variant={"default"}
              className="rounded-full md:h-[52px] md:w-[52px] hover:scale-[0.95] h-6 w-6 p-2 group hover:bg-[#0B3A36]  transition-all duration-300 ease-in-out absolute top-[45%] z-[9] right-5"
            >
              <div className="w-5 flex items-center justify-center relative">
                <ChevronRightIcon
                  fontSize="small"
