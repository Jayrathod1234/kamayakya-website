...
export const getNewsListApi = async ({ stock_name, limit, cursor,page }) => {
  try {
    ...
    const response = await axios.get(`https://api.marketaux.com/v1/news/all?countries=in&search="${stock_name}"&language=en&page=${page}&sort=published_at&api_token=${process.env.NEXT_PUBLIC_MARKET_AUX_TOKEN}`)
