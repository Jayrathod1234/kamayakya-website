      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-6 md:mb-8">
          <p className="text-sm md:text-base text-foreground italic leading-relaxed text-balance text-center">
            "Disclosure with respect to compliance with Annual compliance audit requirement under Regulation 25(3) of
            SEBI (Research Analyst) Regulations, 2014 for last financial years are as under:
          </p>
        </div>
          ...
          <table className="w-full border-collapse">
            ...
            <tbody>
              <tr className="hover:bg-muted/50 transition-colors">
                ...
                <td className="border border-border px-4 py-3 text-foreground">Conducted / Not Conducted</td>
        ...
        <div className="md:hidden space-y-4">
          {[
            { sr: "1", year: "FY 2023-24", status: "Conducted / Not Conducted", remarks: "N/A" },
            { sr: "2", year: "FY 2024-25", status: "Conducted / Not Conducted", remarks: "N/A" },
          ].map((row, idx) => (
            <div
              key={idx}
