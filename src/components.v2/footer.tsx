...
function Socials({href, imgSrc, alt}: Record<string, string>) {
    return (
        <Link target="_blank" href={href}>
            <Image className="h-8 aspect-square md:h-9 inline-block" src={imgSrc} alt={alt} width={40} height={40}
                   priority/>
        </Link>
    );
}
...
export function Footer() {
    return (
        <div className="bg-gradient-to-b from-[#244D4E] to-[#182E35]">
            ...
            <div
                className=" text-white  w-[min(1280px,calc(100%-32px))] min-w-[328px] mx-auto flex flex-col gap-y-16 max-md:gap-y-[21px] pb-5 mt-[58px]">
                <div className=" flex justify-between max-md:flex-col max-md:gap-y-7">
                    <div className=" flex items-center gap-x-[14.77px]">
                        <Image className=" block " src="/KKLogo_footer.png" alt="KamayaKya-logo" width={209} height={40}
                               priority/>
                        <p className="hidden md:block text-sm mt-2">Made in Bharat with ❤️</p>
                    </div>
                    <div className=" flex gap-x-[10px]">
                        <Socials href="https://www.facebook.com/KamayaKya" imgSrc="icons/Facebook.svg"
                                 alt="kamayakya-fb"/>
                        <Socials
                        ...
                        />
                        <Socials href="https://t.me/+5ZpxedvOoothOWZl" imgSrc="/icons/Telegram.svg"
                ...
                <div className=" flex justify-between flex-wrap max-md:flex-col max-md:gap-y-[21px]">
                    <div className=" flex items-start gap-x-[10px]">
                        ...
                        <p className="text-sm md:text-md  max-w-[392px]">
                            Flat No 6, New Nirmal Apartments, Balkrishna Sakharam Dhole Patil Rd, near Akshay Complex
                            Road, Pune,
                            Maharashtra 411001
                        </p>
                    </div>
                ...
                <div
                    className=" flex flex-col pt-10 md:pt-12 gap-y-10  md:gap-y-[60px] border-t border-t-[rgba(228,231,236,0.4)]">
                    {/* <div className=" flex gap-[10px] flex-wrap content-center items-center justify-between max-md:justify-center"> */}
                    <div
                        className=" grid grid-cols-[repeat(auto-fit,_minmax(149px,0.5fr))] gap-[10px] justify-between place-content-center max-phone:place-content-center">
                        <div className=" max-phone:place-self-center place-self-start">
                            <Link href="/Kamayakya-SEBI-License.pdf#toolbar=0&fitH=1" target="_blank">
                                <Image
                                    ...
                                    src={"/sebi.png"}
                                />
                                <Image className=" hidden max-md:inline-block" width={132} height={26} alt="sebi"
                                       src={"/sebi.png"}/>
                            </Link>
                        </div>
                        <div className=" max-phone:place-self-center place-self-center">
                            <Link href="/KMK_MSME_Registration.pdf#toolbar=0&fitH=1" target="_blank">
                                <Image
                                    ...
                                    src="/udyam.png"
                                />
                                <Image className=" hidden max-md:inline-block" width={149} height={29} alt="udyam"
                                       src="/udyam.png"/>
                            </Link>
                        </div>
                    ...
                    <p className=" text-sm text-center">
                        ...
                        carefully before
                        investing. Registration granted by SEBI and certification from NISM in no way guarantee
                        performance of the
                        intermediary or provide any assurance of returns to investors.
                    </p>
                    <div className=" flex flex-col gap-y-5 md:gap-y-12">
                        <div
                            className=" text-white flex flex-wrap gap-x-5 items-center justify-center flex-shrink-0 content-center whitespace-nowrap max-md:text-2xs ">
