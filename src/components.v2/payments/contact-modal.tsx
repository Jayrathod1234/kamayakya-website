...
export function ContactModal({trigger}: { trigger: React.ReactNode }) {
    ...
    return (
        <Dialog open={open} onOpenChange={setOpen}>
            ...
            <DialogContent
                className=" contact__modal p-5 md:p-6 pb-[21px]  max-w-[1200px]  h-[100dvh] md:max-h-[773px] overflow-y-scroll pricing">
                {/* <div className=" h-full p-0"> */}
                <div
                    className=" grid grid-cols-2 max-md:grid-cols-1 grid-rows-[auto_auto] max-md:grid-rows-[auto] md:gap-6 max-w-[1152px]  ">
                    <div
                        className="contact__modal-left hidden md:block md:col-start-1 md:row-span-2 rounded-xl shadow-2xs p-4 overflow-y-scroll  md:pb-8 ">
                        <ContactModalHead/>
                    ...
                    <div
                        className="contacts__container col-start-2 row-start-2 md:overflow-hidden bg-white md:shadow-2xs h-full max-md:py-5 rounded-xl max-md:row-start-3 max-md:col-start-1">
                        <div className=" hidden max-md:block text-center mb-5">
                            <ContactModalHead/>
                        </div>
                        <div
                            className=" mt-[22px] md:p-4 max-md:shadow-none  grid lg:grid-cols-2 grid-row-[auto_auto_auto] gap-4 md:grid-cols-1">
                            <ContactOptionCard
                                value={"+91 9175939641"}
                                label={"Mobile No"}
                                icon={
                            ...
                            <p className=" lg:row-start-3 lg:col-span-2 text-gray-700 text-sm md:row-start-4 md:col-span-1 text-center">
                                Call us during business hours, Monday to Friday, between 10am and 7pm IST, for
                                assistance.
                            </p>
                        </div>
                    </div>
                    <div
                        className=" border-t-[1px] border-t-gray-150 md:border-0 hidden py-5 max-md:grid max-md:col-start-1 max-md:row-start-5 max-md:row-span-2 h-fit md:p-5">
