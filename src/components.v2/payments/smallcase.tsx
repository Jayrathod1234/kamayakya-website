...
export function SmallCaseCard() {
    ...
    return (
        ...
        <div id="effortless-section" className=" pt-5">
            <div
                className="lg:gap-x-11 lg:flex-nowrap  overflow-hidden relative p-7 px-[1.25rem] md:px-[1.95rem]  bg-[#1E7AE0] rounded-xl flex flex-col md:flex-row justify-center items-center gap-6 text-center md:h-[27.125rem] lg:bg-[url(/effortless_investors_bg.svg)] bg-cover bg-no-repeat">
                <div
                    className=" text-white flex flex-col items-center justify-center md:items-start md:max-w-[484px] md:text-start">
                    ...
                    <p className=" text-md text-gray-200">
                        Get access to professionally created basket of NSE stocks. Invest in multiple stocks in 1
                        click{" "}
                    </p>
                    <div className=" mt-6 md:mt-[41px]">
                        ...
                        >
                            <Link className=" text-inherit" target="_blank"
                                  href={"https://kamayakya.smallcase.com/#portfolios"}>
                ...
                <div
                    className="max-w-[480px] w-full flex flex-col justify-center items-center  h-[378px] rounded-lg overflow-hidden ">
                    <SmallcaseEmbed/>
