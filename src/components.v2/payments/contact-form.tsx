...
export function ContactForm({closeModal}: { closeModal: () => void }) {
    ...
    return (
        <>
            <div style={{fontFamily: "Open Sans !important"}}
                 className=" placeholder:text-gray-400 placeholer:text-md ">
                ...
                />
                {error.nameError ?
                    <p className=" text-sm text-[rgba(240,68,56,1)] mt-[6px] text-left">Enter name</p> : null}
            </div>
            <div className="p-0">
          ...
          />*/}
            ...
            <div className="">
                ...
                >
                    ...
                    >
                        <SelectTrigger
                            className=" pricing px-[14px] py-[10px] max-h-11 lg:h-11 text-md data-[placeholder]:text-gray-400 placeholder:text-gray-400 placeholder:text-md focus:outline-none  focus:ring-0  ring-0 focus:ring-offset-0 focus-visible:outline-none focus-visible:ring-0 focus-visible:ring-offset-0">
