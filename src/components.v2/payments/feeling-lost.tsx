    ...
    return (
        ...
        <div className=" bg-[url(/feeling_lost_bg.webp)] text-white bg-no-repeat bg-cover md:pt-[60px]">
            <div className=" py-[60px] md:pt-[120px] md:pb-[333px]">
                <div
                    className="grid grid-cols-1 md:grid-cols-2 md:grid-rows-1 place-content-center place-items-center w-[min(1200px,calc(100%-32px))] min-w-[328px] mx-auto">
                    <div className=" md:col-start-2 md:row-start-1 pt-[71px] md:pt-0">
                        ...
                        <Image className="hidden md:inline-block" height={115} width={177} src={"/ship.svg"}
                               alt="ship"/>
                    </div>
                                        ...
                                        endIcon={
                                            <div>
                                                ...
                                                <ArrowRight height={18} width={18}
                                                            className="block md:hidden text-inherit"/>
                                            </div>
                                        }
