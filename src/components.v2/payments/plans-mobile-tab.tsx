...
export function PlansMobileTab({ plan, features, popular = false, selected = false, onClick }: TPlansMobileTab) {
  return (
    ...
    >
      {popular && (
        <div className={` flex gap-x-[2px] flex-nowrap items-center justify-center  text-center py-[1px] md:py-[3px] px-[6px] whitespace-nowrap font-semibold bg-brand-300 text-white rounded-t-lg absolute -top-[1.2rem] left-0 z-30 w-full ${selected ? "shadow-[0px_-3px_0px_4px_#75CDC5]" : "shadow-[0px_-3px_0px_2.8px_#75CDC5]"}`}>
