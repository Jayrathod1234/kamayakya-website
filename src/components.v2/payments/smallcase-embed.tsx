...
export const SmallcaseEmbed3 = () => {
  ...
  return (
    ...
    >
      <iframe
        className={` rounded-lg block phone:hidden sm:hidden md:block lg:hidden w-[300px] max-w-[300px] max-h-[378px] h-[378px]`}
        src="https://www.smallcase.com/embed/smallcase?scid=KAKYNM_0001&cardsize=small&primaryCta=view"
      ></iframe>
      <iframe
        className={` rounded-lg hidden phone:block md:hidden lg:block w-full max-w-[500px] max-h-[300px] h-[300px]`}
...
export const SmallcaseEmbed4 = () => {
  ...
  return (
    ...
    >
      <iframe
        className={` rounded-lg block phone:hidden sm:hidden md:block lg:hidden w-[300px] max-w-[300px] max-h-[378px] h-[378px]`}
        src="https://www.smallcase.com/embed/smallcase?scid=KAKYFMM_0002&cardsize=small&primaryCta=view"
      ></iframe>
      <iframe
        className={` rounded-lg hidden phone:block md:hidden lg:block w-full max-w-[500px] max-h-[300px] h-[300px]`}
        src="https://www.smallcase.com/embed/smallcase?scid=KAKYFMM_0002&cardsize=big&primaryCta=view"
      ></iframe>
    </div>
  );
};
