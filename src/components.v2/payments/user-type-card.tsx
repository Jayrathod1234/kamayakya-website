...
export function UserTypeCard({imgSrc, title, attributes, btnText, icon}: TUserTypeCard) {
    ...
    return (
        <div
            className=" flex flex-col items-center justify-center min-h-[402px] max-h-[412px] w-[173px] gap-x-2 p-2 pb-[10px] text-center border border-white rounded-lg backdrop-blur-[20px] bg-[linear-gradient(0deg,_#FFFFFF66_0%,_#FFFFFF66_100%)]">
            <div>
            ...
            <div className=" relative w-full flex justify-center items-center">
                <div
                    className=" absolute h-[1px] w-1/2 z-0 opacity-50 bg-[radial-gradient(50%_50%_at_50%_50%,#75CDC5_66.5%,rgba(196,255,250,0.48)_100%)]"></div>
                <div
                    className=" h-[18px] relative z-10 aspect-square rounded-full bg-[linear-gradient(rgba(18,91,84,1),rgba(18,173,183,1))] flex justify-center items-center">
