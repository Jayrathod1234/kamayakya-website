...
export function Newsletter() {
    ...
    return (
        <div
            ...
            <div
                className="w-[min(1280px,calc(100%-32px))] min-w-[328px] mx-auto md:w-[566px] md:mt-[109px] md:mb-[126px]">
                <h3 className=" text-xl font-bold md:text-display-md">
                    Guess who doesn’t like to “Spam” ? <span className=" text-[#32D583]">Us.</span>
                </h3>
                <div
                    className=" mt-10 md:mt-[75px] flex flex-col items-center gap-3 md:flex-row md:gap-x-3 md:justify-center">
                ...
                <div>
                    ...
                    {emailError ? (
                        <p className=" text-sm text-[rgba(240,68,56,1)] mt-[6px] text-left max-w-[350px] md:max-w-[566px] mx-auto">Enter
                            valid email</p>
                    ) : null}
