...
export const PlanCardHead = ({plan, label}: TPlanCardHead) => {
    return (
        <div className=" flex justify-between flex-wrap">
            ...
            {label && (
                <div
                    className=" px-3 py-[3px] border border-brand-300 bg-brand-100 text-3xs text-center text-brand-400 font-semibold uppercase rounded-3xl flex items-center justify-center">
                    {label}
                </div>
            )}
        </div>
...
export function PlanCardDesktop({
    ...
    return (
        ...
        >
            {popular && (
                <div
                    className=" flex flex-row items-center justify-center gap-x-[4px] px-2 py-[7px] rounded-t-[10px] bg-brand-300 text-white font-semibold absolute w-full lg:-top-[2.3rem] max-md:top-0 ">
