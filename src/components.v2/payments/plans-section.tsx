      ...
      <div className=" relative flex justify-center mb-14 md:mb-0 pt-10 md:pb-14 pb-6">
        <div className="relative">
          ...
          <Image
            ...
            alt="save-33%"
          />
          <Tabs activeValue={currentTab} setSelectedOption={setCurrentTab as  React.Dispatch<React.SetStateAction<string>>} defaultOption="1year" options={tabOptions} variant={TabsVariant.md} />
