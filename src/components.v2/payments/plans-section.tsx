        ...
        <div>
          ...
          /> */}
                    <Image
                        ...
                        alt="save-33%"
                    />
                    <Tabs setSelectedOption={setCurrentTab} defaultOption="1year" options={tabOptions}
                          variant={TabsVariant.md}/>
                    <Image className=" absolute left-[35%] top-10" height={28} width={94} src={"/save_25.png"}
                           alt="save-25%"/>
                </div>
            </div>
            <div>
                ...
                <div
                    className="hidden md:grid md:grid-cols-2 md:grid-rows-2 md:gap-8 lg:flex lg:gap-y-8 lg:gap-x-0 flex-wrap justify-center">
                    {plans && plans[currentTab] ? (
                        <>
                            {plans[currentTab].map((plan: TPlanResponse) => {
                ...
                <div className=" mt-6 md:mt-10 text-center flex items-center justify-center ">
                    <TooltipProvider delayDuration={0}>
                        <Tooltip open={openTooltip} onOpenChange={setOpenTooltip}>
                            ...
                            >
                                <div
                                    className=" px-7 md:px-16 py-[9px] bg-gray-50 rounded-full border border-brand-400">
                            ...
                            <TooltipContent side="bottom" className=" bg-black text-white border-0 p-3 max-w-[425px]">
                                <p className=" leading-6 w-[350px] md:w-full]">
                                    We understand that effective investing requires time and patience, which is why we
                                    suggest minimum
                                    annual membership. Our strategy reflects our ethos that long-term commitment is key
                                    to unlocking the
