...
export function UserTypeTabDesktop({ usertype, icon, active, handleClick }: TUserTypeTabDesktop) {
  ...
  const tabActiveStyle = active ? "rounded-b-none shadow-none pb-3 border-transparent":"border-red-500";
  const clipStyle =
  ...
  const tabFontStyle = active ? " text-xl font-semibold text-brand-400" : " text-gray-600";
