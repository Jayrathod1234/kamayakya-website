...
export function EnterpriseCard() {
    ...
    return (
        <div
            className=" grid grid-cols-1 md:grid-cols-2 place-content-center place-items-center gap-6 md:gap-x-11 items-center justify-center">
            ...
            <div className=" flex flex-col items-center md:items-start text-center  md:text-start">
                ...
                <p className=" text-md mt-3 md:mt-4 text-gray-600">
                    For wealth management businesses like Family Office, PMS, AIF, MF and other wealth creators in the
                    ecosystem.{" "}
                </p>
