                                ...
                                <NavigationMenuItem className=" m-0 hidden lg:flex">
                                    ...
                                    <NavigationMenuContent className=" z-20 w-auto">
                                        ...
                                        >
                                            ...
                                            >
                                                <Image className=" object-cover h-full w-full rounded-xl"
                                                       src={"/pricing/home-hover.png"} height={284} width={284}
                                                       alt="nav-img"/>
                                            </li>
                                        </ul>
                                    </NavigationMenuContent>
            ...
            <li className="relative m-0 group ">
                <NavigationMenuLink asChild>
                    ...
                    >
                        ...
                        <div>
                            <div
                                className="text-sm font-medium leading-none text-gray-950 mb-1 flex gap-x-2 items-center">
                                <span className=" whitespace-nowrap">{title}</span>
                                <span className=" invisible group-hover:visible">{endIcon ||
                                    <ArrowRight size={12} className=" text-gray-400"/>}</span>
                            </div>
