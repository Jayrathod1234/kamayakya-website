            ...
            <SheetContent className=" pricing flex flex-col p-0 overflow-y-scroll pr-0">
                                                ...
                                                {HOME_OPTIONS.filter((options) =>
                                                    ...
                                                    >
                                                        <li key={options.title}
                                                            className="flex gap-x-[10px] items-center mb-0 p-3 pl-2">
                                ...
                                <Link key={nav.title} className=" text-inherit" href={nav.link}>
                                    ...
                                    >
                                        ...
                                        {stockRecommendation[nav.title as "Stocks to Buy" | "Track Record"] ? (
                                            <NewStockbadge
                                                label={stockRecommendation[nav.title as "Stocks to Buy" | "Track Record"]}/>
                                        ) : null}
                                    </li>
                                </Link>
                            ))}
                ...
                {isLoggedIn ? (
                    ...
                    <div className=" p-4 mt-auto">
                        ...
                        <p className=" text-sm text-gray-500 mb-5">Log in to unlock 3 HOT stocks and our Track Record
                            for free.</p>
                        {/* <Button onClick={handleClick} variant={ButtonVariant.primary} size={ButtonSize.sm} customStyle=" w-full mb-2">Sign up</Button> */}
                        <Button onClick={handleClick} variant={ButtonVariant.secondary} size={ButtonSize.sm}
                                customStyle=" w-full">
                            Login
                        </Button>
                    </div>
