...
const HotStockSection = ({ items }) => {
  ...
  const handleContactButton = () => {
    ...
    mp.track("exploreplans_clicked", {
      page: "StockPicks_page",
      pagegroup: "Hot Stocks",
    });
  };
              ...
              <div className="bg-[#fff] rounded-[20px] sm:px-10 px-4 sm:pt-10 pb-8 py-5 gap-10 text-center">
                ...
                <div className="bg-white bg-[url('/assets/grid.png')] bg-cover sm:py-[74px] sm:pl-[41px] pr-20  sm:flex  items-center  rounded-[10px]">
                  <div className="flex-1 w-full sm:pt-0 pt-5">
                    <img src="/assets/noto_locked.png" alt="" className="sm:w-[46px] w-[56px] lg:m-0 m-auto" />
                    ...
                    {isLoggedIn ? (
                      <>
                        <p className="sm:text-display-sm text-lg font-bold sm:leading-[38px] leading-7 sm:text-left text-center font-open_sans pt-4 max-w-[324px] tracking-normal text-[#0C111D]">
                          ...
                          <span className="text-[#108973] pl-1 pr-1">30+ potential multibagger picks</span>
                          <br className="sm:block hidden"></br>with KamayaKya membership.
                        </p>
                      ...
                      <>
                        ...
                        <div className="    sm:!mt-6 !mt-3 lg:m-0 m-auto lg:block inline-block lg:pb-0 pb-7">
                          <ButtonnArrow
                            onClick={() => {
                              const mp = getMixPanelClient();
                              mp.track("getFreeStocks_clicked", {
                                page: "StockPicks_page",
                              });
                              handleLogin();
                            }}
                        ...
                        {items.length > 0 &&
                          items.map(
                            (
                              ...
                              let tabImage = null;
                              let cardClass = "";
                              let innerClass = "relative rounded-lg bg-white shadow-6xs  w-full";
                                ...
                                >
                                  <div className={`${index !== 1 ? "scale-75" : " scale-95 "} flex justify-center`}>
                                    <div className="absolute z-10 -top-1">
                                      {tabImage && <img src={`/assets/${tabImage}.png`} alt="" className="w-[160px]" />}
                                    </div>
                                      ...
                                      <div className={innerClass + " w-full"}>
                                        <div className="pt-[20px] px-[20px] flex gap-[36px] items-center justify-between">
                                          ...
                                          <div className="tooltip">
                                            <img src="/assets/play.gif" alt="" className="w-[24px] blur-[2px]" />
                                          ...
                                          <div className="p-[8px] rounded-xl bg-[#f7f8fa]">
                                                  ...
                                                  <div className="tooltip">
                                                    ...
                                                    <span className="tooltiptext tooltiptext2 relative shadow-3xl ">
                                                      ...
                                                      <div className="text-gray-800 text-2xs font-normal ">
                                                        Upside Left means how much the stock price could rise from its
                                                        current level.
                                                      </div>
                                                      <div className="mt-2 p-2 bg-[#F6F7F9] gap-1 grid rounded-lg">
                                                        ...
                                                        <p className="text-2xs text-gray-600 font-normal">
                                                          If a stock's price is ₹100 and the Upside Left is 20%, it
                                                          might go up to ₹120.
                                                        </p>
                                                      </div>
                                                    </span>
                                            ...
                                            <div className="flex justify-between pt-[8px] px-[9px] ">
                                              ...
                                              <div className="flex gap-[3px] items-center font-open_sans sm:max-w-[150px] max-w-[164px] whitespace-nowrap">
                                                ...
                                                {!gain_loss ? (
                                                  <p className="text-2xs font-bold text-gray-800 font-open_sans h-[11px] w-[27px] rounded-full bg-gray-200"></p>
                                                ) : (
...
export const HotStockSectionBlurVertical = ({ items }) => {
  const { stockSector } = useStockPicks();
  ...
  return (
    <div>
      ...
      {/* <div className="container sm:mx-auto p-0"> */}
      {!isLatop ? (
        <div className=" rounded-[20px] sm:block none  mx-auto">
          <div className="rounded-[20px] sm:px-10 px-4 sm:pt-10 pb-8 py-5 gap-10 text-center">
            <div className="bg-white bg-[url('/assets/grid.png')] bg-cover py-10  flex flex-col justify-center  items-center  rounded-[10px]">
              <div className="flex-1 w-full sm:pt-0 pt-5">
                {isLoggedIn ? (
                  <>
                    <p className="sm:text-display-sm text-lg font-bold sm:leading-[38px] leading-7 sm:text-left text-center font-open_sans pt-4 max-w-[324px] tracking-normal text-[#0C111D]">
                  ...
                  <>
                    {/* non log in user 3 stock add   */}
                    <p className=" font-semibold text-brand-700">HOT STOCKS</p>
                    <p className="sm:text-display-sm text-lg font-bold sm:leading-[38px] leading-7 text-center font-open_sans tracking-normal text-[#0C111D]">
                      Log in and unlock <span className="text-[#108973] pl-1 pr-1">3 HOT stocks</span>
                      for Free
                    </p>
                  </>
                )}
                                  ...
                                  <div className={innerClass + " w-full"}>
                                    ...
                                    <div className="pt-[12px] px-[20px] pb-[20px]">
                                      <div className=" flex items-center gap-[8px] ">
                                        {stockSector && sector && (
                                          <div className="py-[2px] pr-[16px] pl-[6px] rounded-2xl border border-[#FEF0C7] bg-orange-100 flex gap-[4px] whitespace-nowrap">
                                            <img src={`/sector-images/${sectorIcons[sector]}`} alt="" className="w-3" />
                                            <p className="text-[7px] font-bold text-[#A3651A] font-open_sans">
                                              {stockSector[sector]}
                                            </p>
                                          </div>
                                              ...
                                              <div className="tooltip">
                                                ...
                                                <span className="tooltiptext tooltiptext2 relative shadow-3xl ">
                                                  ...
                                                  <div className="mt-2 p-2 bg-[#F6F7F9] gap-1 grid rounded-lg">
                                                    ...
                                                    <p className="text-2xs text-gray-600 font-normal">
                                                      If a stock's price is ₹100 and the Upside Left is 20%, it might go
                                                      up to ₹120.
                                                    </p>
                                                  </div>
                                                </span>
              ...
              <div className="    sm:!mt-6 !mt-3 lg:m-0 m-auto lg:block inline-block lg:pb-0 pb-7">
                <ButtonnArrow onClick={handleLogin} variant={ButtonVariant.primary} size={ButtonSize.lg}>
                  Get Free Stocks
                </ButtonnArrow>
              </div>
            </div>
          ...
          <div className="bg-white bg-[url('/assets/grid.png')] bg-cover pt-5  pb-2  text-center sm:rounded-[20px] rounded-[20px] ">
            ...
            {isLoggedIn ? (
              <>
                ...
                <div className="  sm:!mt-6 !mt-3 lg:m-0 m-auto lg:block inline-block lg:pb-0 pb-7">
                  <Link href={`/pricing`}>
                    <ButtonnArrow onClick={handleContactButton} variant={ButtonVariant.primary} size={ButtonSize.lg}>
                      Explore Plans
                    </ButtonnArrow>
                  </Link>
                </div>
