                        ...
                        <div className="flex flex-col gap-4 md:gap-6 lg:gap-8">
                          ...
                          >
                            ...
                            <div
                              ...
                              }  p-4 pt-2 pr-2  rounded-md bg-custom-gradient flex flex-col max-h-[95px]`}
                            >
                              <div className="flex flex-col md:flex-row justify-between">
                                <div className=" flex justify-between w-full">
                                  <div className="flex gap-1 items-center">
                                    <p className="font-open_sans text-sm font-semibold text-[#FCFCFD]">Upside Left</p>
                                    <div className="relative group">
                                      <img
                                      ...
                                      <div className="absolute z-[999] top-6   shadow-3xl left-[50px] transform -translate-x-1/2 mt-2 hidden group-hover:block bg-white  text-sm rounded-lg py-2 px-4 w-[300px]">
                                        <div className="w-full grid gap-1 relative">
                                          ...
                                          <p className="text-[12px]">
                                            Upside Left means how much the stock price could rise from its current
                                            level.
                                          </p>
                              ...
                              <div className="flex mt-auto flex-col sm:flex-row items-start sm:items-baseline gap-1 text-[16px] sm:text-display-xs text-white font-bold">
                                {upside_left}%
                                <span className="text-[12px] truncate whitespace-nowrap  text-white font-medium">
                            ...
                            <div
                              className={`w-full min-w-[150px]    p-4 pt-2 pr-2 rounded-md bg-white flex flex-col max-h-[95px]`}
                            >
                              <div className="flex flex-col sm:flex-row justify-between">
                                <div className=" flex justify-between  w-full">
                                  <div className="flex gap-[6px] items-center">
                                    <p className="font-open_sans text-sm font-semibold text-[#1D2939]">Total Returns</p>
                                  </div>
                                  <div className="hidden sm:flex justify-end bg-[#F9FAFB] p-2 rounded-md">
                                    <img src="/assets/Layer_1.svg" alt="Returns Icon" className=" h-6 w-6" />
                                  </div>
                                </div>
                              </div>
                                ...
                                <div className="flex flex-col sm:flex-row justify-between">
                                  <div className="flex justify-between w-full">
                                    <div className=" flex items-center">
                                      <p className="font-open_sans text-sm font-semibold text-[#1D2939]">Total CAGR</p>
                                      <div className="relative group">
                                        <img
                                  ...
                                  <div className="hidden sm:flex justify-end bg-[#F9FAFB] p-2 rounded-md">
                                    <img src="/assets/upper.svg" alt="target" className=" h-6 w-6" />
                                  </div>
                                </div>
                                <div className="flex mt-auto flex-col sm:flex-row items-start sm:items-center gap-1 text-[16px] sm:text-[20px] lg:text-[20px] text-[#344054] font-bold">
                                  {gain_loss >= 0 ? (
