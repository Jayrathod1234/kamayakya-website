                    ...
                    <div className="flex-1">
                      {hasVideo ? (
                        ...
                        <div className="relative group">
                          <button
                            className="w-full bg-gray-50 rounded-lg p-2 flex items-center justify-center gap-2 hover:bg-gray-100 cursor-not-allowed"
                          >
                            <img
                          ...
                          <div className="absolute top-full left-[90%] transform -translate-x-1/2 mt-2 hidden group-hover:block w-max max-w-xs bg-white shadow-lg rounded-lg border border-gray-200 p-4 text-center z-10">
                            ...
                            <p className="text-sm text-[#475467]">
                              Well, this video took a permanent vacation! 😅 But don’t worry, fresh content is always on the horizon. Stay tuned! 🌟
                            </p>  
                            {/* Tooltip Arrow */}
