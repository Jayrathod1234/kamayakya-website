...
function DrawerFilter() {
  ...
  const [tempActionCall, setTempActionCall] = useState(actionCall);
                      ...
                      <Grid container spacing={2} alignItems="center" pt={2}>
                        <Grid item xs={5}>
                          <TextField
                            ...
                            onChange={(e) => handleUpsideLeftInputChange(e, "min")}
                            InputProps={{
                      ...
                      <FormGroup>
                        {Object.keys(strategyTagList || {}).map((key) => (
                          <FormControlLabel
                            ...
                            label={<span style={{ fontFamily: "Open Sans, sans-serif" }}>{strategyTagList[key]}</span>}
                          />
                        ))}
                      </FormGroup>
                    </AccordionDetails>
                                  ...
                                  <Checkbox
                                    ...
                                    onClick={() => {
                                      if (
                                        ...
                                        const updatedRecency = Object.keys(tempRecency).reduce((acc, key) => {
                                          acc[key] = false;
                                          return acc;
                                        }, {});
                                  ...
                                  <Checkbox
                                    ...
                                    onClick={() => {
                                      if (
                                        ...
                                        const updatedTempTimeLeft = Object.keys(tempTimeLeft).reduce((acc, key) => {
                                          acc[key] = false;
                                          return acc;
                                        }, {});
                            ...
                            <FormGroup sx={{ padding: "0px !important" }}>
                              ...
                              >
                                <FormControlLabel
                                  ...
                                  control={
                                    <Checkbox
                                      checked={tempStrategyTag.length === Object.keys(strategyTagList || {}).length}
                                  ...
                                  label={
                                    ...
                                    >
                                      {tempStrategyTag.length === Object.keys(strategyTagList || {}).length
                                        ? "Deselect"
                                        : "Select"}{" "}
                                      All
                                    </span>
