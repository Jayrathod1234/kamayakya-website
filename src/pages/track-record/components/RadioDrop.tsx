...
export default function CustomSortMenu({ isLabel }: { isLabel: boolean }) {
  const trackRecordContext = useTrackRecord();
  if (!trackRecordContext) {
    return null;
  }
  const { setSortValue, setSortBy } = trackRecordContext;
  ...
  const handleChange = (event: React.ChangeEvent<HTMLInputElement>) => {
    ...
    setSelectedValue(value); // Update local state to reflect the change in UI
        ...
        <>
          ...
          >
            <Box px={2} py={1}>
              ...
              <RadioGroup name="Returns" value={selectedValue} onChange={handleChange}>
                <MenuItem>
                  <FormControlLabel
                    value="returns_desc"
                    control={
                      ...
                      <Box display="flex" alignItems="center">
                        {/* <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                          <path
                            ...
                            stroke={selectedValue === "returns_desc" ? "#108973" : "#344054"}
                            strokeWidth="1.2"
                            strokeLinecap="round"
                            strokeLinejoin="round"
                          />
                        ...
                        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                          ...
                          />
                          <path
                            d="M18 13.5L15.375 16M15.375 16L12.5 13.5M15.375 16L15.375 10"
                            stroke={selectedValue === "returns_desc" ? "#108973" : "#344054"}
                            stroke-width="1.2"
                            stroke-linecap="round"
                            stroke-linejoin="round"
                        ...
                        <span
                          style={{
                            marginLeft: "8px",
                            color: selectedValue === "returns_desc" ? "#108973" : "#344054",
                            fontFamily: "Open Sans",
                            fontSize: "14px",
                          }}
                        >
                    ...
                    label={
                      <Box display="flex" alignItems="center">
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                          <path
                            d="M12 5H3H5.45455C6.32253 5 7.15496 5.33112 7.76871 5.92052C8.38247 6.50992 8.72727 7.30932 8.72727 8.14286C8.72727 8.97639 8.38247 9.77579 7.76871 10.3652C7.15496 10.9546 6.32253 11.2857 5.45455 11.2857H3L7.90909 16M3 8.14286H12"
                            stroke={selectedValue === "returns_asc" ? "#108973" : "#344054"}
                            strokeWidth="1.2"
                            strokeLinecap="round"
                            strokeLinejoin="round"
                          />
                        ...
                        <span
                          style={{
                            marginLeft: "8px",
                            color: selectedValue === "returns_asc" ? "#108973" : "#344054",
                            fontFamily: "Open Sans",
                            fontSize: "14px",
                          }}
                        >
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width="260" height="2" viewBox="0 0 260 2" fill="none">
            ...
            <Box px={2} py={1}>
              ...
              <RadioGroup name="Recency" value={selectedValue} onChange={handleChange}>
                <MenuItem
                  sx={{
                    marginBottom: "10px",
                  }}
                      ...
                      <Box display="flex" alignItems="center">
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                          <path
                            ...
                            stroke={selectedValue === "recency_desc" ? "#108973" : "#344054"}
                            strokeWidth="1.2"
                            strokeLinecap="round"
                            strokeLinejoin="round"
                          />
                        ...
                        <span
                          style={{
                            marginLeft: "8px",
                            color: selectedValue === "recency_desc" ? "#108973" : "#344054",
                            fontWeight: 400,
                            fontFamily: "Open Sans",
                            fontSize: "14px",
                          }}
                    ...
                    label={
                      <Box display="flex" alignItems="center">
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                          <path
                            d="M13.3125 11.375L10.5 10.4375V6.51739M18 9.5C18 5.35786 14.6421 2 10.5 2C6.35786 2 3 5.35786 3 9.5C3 13.6421 6.35786 17 10.5 17C10.9807 17 11.4507 16.9548 11.9063 16.8684"
                            stroke={selectedValue === "recency_asc" ? "#108973" : "#344054"}
                            strokeWidth="1.2"
                            strokeLinecap="round"
                            strokeLinejoin="round"
                          />
                        ...
                        <span
                          style={{
                            marginLeft: "8px",
                            color: selectedValue === "recency_asc" ? "#108973" : "#344054",
                            fontWeight: 400,
                            fontFamily: "Open Sans",
                            fontSize: "14px",
                          }}
            ...
            <Box px={2} py={1} borderTop="1px solid #E0E0E0">
              ...
              <RadioGroup name="Time Left" value={selectedValue} onChange={handleChange}>
                <MenuItem
                  sx={{
                    marginBottom: "10px",
                  }}
                      ...
                      <Box display="flex" alignItems="center">
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                          <path
                            ...
                            stroke={selectedValue === "time_left_desc" ? "#108973" : "#344054"}
                            strokeWidth="1.2"
                            strokeLinecap="round"
                            strokeLinejoin="round"
                          />
                        ...
                        <span
                          style={{
                            marginLeft: "8px",
                            color: selectedValue === "time_left_desc" ? "#108973" : "#344054",
                            fontFamily: "Open Sans",
                            fontSize: "14px",
                          }}
                        >
                    ...
                    label={
                      <Box display="flex" alignItems="center">
                        {/* <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                          <path
                            d="M14.9956 16.6429C14.9956 17.1162 14.6146 17.5 14.1445 17.5H6.05944C5.58941 17.5 5.20837 17.1162 5.20837 16.6429V14.3531C5.20837 14.1701 5.26651 13.992 5.37428 13.8447L7.8151 10.5085C8.03632 10.2061 8.03632 9.79391 7.8151 9.49154L5.37428 6.15534C5.26651 6.00804 5.20837 5.82986 5.20837 5.64689V3.35714C5.20837 2.88376 5.58941 2.5 6.05944 2.5H14.3573C14.8273 2.5 15.2084 2.88376 15.2084 3.35714V5.64689C15.2084 5.82986 15.1502 6.00804 15.0425 6.15534L12.5882 9.50993C12.3735 9.8034 12.3666 10.2015 12.571 10.5024M8.1871 5.07143H12.2297"
                            stroke={selectedValue === "time_left_asc" ? "#108973" : "#344054"}
                            strokeWidth="1.2"
                            strokeLinecap="round"
                            strokeLinejoin="round"
                          />
                        ...
                        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                          <path
                            d="M12.5881 10.4901C12.3734 10.1966 12.3664 9.79846 12.5708 9.4976L14.8468 6.14742C14.9437 6.00485 14.9955 5.83614 14.9955 5.6634V3.35714C14.9955 2.88376 14.6145 2.5 14.1444 2.5H6.05932C5.58929 2.5 5.20825 2.88376 5.20825 3.35714V5.64689C5.20825 5.82986 5.26639 6.00804 5.37416 6.15534L7.81498 9.49154C8.03619 9.79391 8.03619 10.2061 7.81498 10.5085L5.37416 13.8447C5.26639 13.992 5.20825 14.1701 5.20825 14.3531V16.6429C5.20825 17.1162 5.58929 17.5 6.05932 17.5H14.3572C14.8272 17.5 15.2083 17.1162 15.2083 16.6429M8.18698 14.9286H12.2295"
                            stroke={selectedValue === "time_left_asc" ? "#108973" : "#344054"}
                            stroke-width="1.2"
                            stroke-linecap="round"
                            stroke-linejoin="round"
                          />
                          <path
                            d="M17 12.1667L15.0909 10.5M15.0909 10.5L13 12.1667M15.0909 10.5L15.0909 14.5"
                            stroke={selectedValue === "time_left_asc" ? "#108973" : "#344054"}
                            stroke-width="1.2"
                            stroke-linecap="round"
                            stroke-linejoin="round"
                        ...
                        <span
                          style={{
                            marginLeft: "8px",
                            color: selectedValue === "time_left_asc" ? "#108973" : "#344054",
                            fontFamily: "Open Sans",
                            fontSize: "14px",
                          }}
                        >
            ...
            <Box px={2} py={1} borderTop="1px solid #E0E0E0">
              ...
              <RadioGroup name="Upside Left" value={selectedValue} onChange={handleChange}>
                <MenuItem
                  sx={{
                    height: "36px",
                    marginBottom: "10px",
                      ...
                      <Box display="flex" alignItems="center" sx={{}}>
                        {/* <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                          <path
                            ...
                            stroke={selectedValue === "upside_left_desc" ? "#108973" : "#344054"}
                            strokeWidth="1.2"
                            strokeLinecap="round"
                            strokeLinejoin="round"
                          />
                        ...
                        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                          <path
                            d="M5.8335 11.667L7.74433 9.75616C7.9006 9.59993 8.11253 9.51217 8.3335 9.51217C8.55447 9.51217 8.76639 9.59993 8.92266 9.75616L10.2443 11.0778C10.4006 11.2341 10.6125 11.3218 10.8335 11.3218C11.0545 11.3218 11.2664 11.2341 11.4227 11.0778L14.1668 8.33366M14.1668 8.33366V10.417M14.1668 8.33366H12.0835"
                            stroke={selectedValue === "upside_left_desc" ? "#108973" : "#344054"}
                            stroke-width="1.2"
                            stroke-linecap="round"
                            stroke-linejoin="round"
                          />
                          <path
                            d="M18 4.83431L16.0909 6.50098M16.0909 6.50098L14 4.83431M16.0909 6.50098L16.0909 2.50098"
                            stroke={selectedValue === "upside_left_desc" ? "#108973" : "#344054"}
                            stroke-width="1.2"
                            stroke-linecap="round"
                            stroke-linejoin="round"
                          />
                          <path
                            d="M18.3334 8.75033V10.0003C18.3334 13.9287 18.3334 15.8928 17.1126 17.1128C15.8934 18.3337 13.9284 18.3337 10.0001 18.3337C6.07175 18.3337 4.10758 18.3337 2.88675 17.1128C1.66675 15.8937 1.66675 13.9287 1.66675 10.0003C1.66675 9.06033 1.66675 8.23199 1.68341 7.50033M11.2501 1.66699H10.0001C6.07175 1.66699 4.10758 1.66699 2.88675 2.88699C2.52008 3.25449 2.26258 3.68949 2.08341 4.22533"
                            stroke="#475467"
                            stroke-width="1.2"
                            stroke-linecap="round"
                            stroke-linejoin="round"
                    ...
                    label={
                      <Box display="flex" alignItems="center">
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                          <path
                            d="M5.83337 11.666L7.74421 9.75518C7.90048 9.59896 8.1124 9.51119 8.33337 9.51119C8.55434 9.51119 8.76627 9.59896 8.92254 9.75518L10.2442 11.0768C10.4005 11.2331 10.6124 11.3208 10.8334 11.3208C11.0543 11.3208 11.2663 11.2331 11.4225 11.0768L14.1667 8.33268M14.1667 8.33268V10.416M14.1667 8.33268H12.0834"
                            stroke={selectedValue === "upside_left_asc" ? "#108973" : "#344054"}
                            strokeWidth="1.2"
                            strokeLinecap="round"
                            strokeLinejoin="round"
                          />
                        ...
                        <span
                          style={{
                            marginLeft: "8px",
                            color: selectedValue === "upside_left_asc" ? "#108973" : "#344054",
                            fontWeight: 400,
                            fontSize: "14px",
                            fontFamily: "Open Sans",
                          }}
                    ...
                    label={
                      <Box display="flex" alignItems="center">
                        ...
                        <span
                          style={{
                            marginLeft: "8px",
                            color: selectedValue === "returns_desc" ? "#108973" : "#17172E",
                            fontWeight: 400,
                            fontFamily: "Open Sans",
                            fontSize: "14px",
                          }}
                    ...
                    label={
                      <Box display="flex" alignItems="center">
                        ...
                        <span
                          style={{
                            marginLeft: "8px",
                            color: selectedValue === "returns_asc" ? "#108973" : "#17172E",
                            fontWeight: 400,
                            fontFamily: "Open Sans",
                            fontSize: "14px",
                          }}
                    ...
                    label={
                      <Box display="flex" alignItems="center">
                        ...
                        <span
                          style={{
                            marginLeft: "8px",
                            color: selectedValue === "recency_desc" ? "#108973" : "#17172E",
                            fontWeight: 400,
                            fontFamily: "Open Sans",
                            fontSize: "14px",
                          }}
                    ...
                    label={
                      <Box display="flex" alignItems="center">
                        ...
                        <span
                          style={{
                            marginLeft: "8px",
                            color: selectedValue === "recency_asc" ? "#108973" : "#17172E",
                            fontWeight: 400,
                            fontFamily: "Open Sans",
                            fontSize: "14px",
                          }}
                    ...
                    label={
                      <Box display="flex" alignItems="center">
                        ...
                        <span
                          style={{
                            marginLeft: "8px",
                            color: selectedValue === "time_left_desc" ? "#108973" : "#17172E",
                            fontWeight: 400,
                            fontFamily: "Open Sans",
                            fontSize: "14px",
                          }}
                    ...
                    label={
                      <Box display="flex" alignItems="center">
                        ...
                        <span
                          style={{
                            marginLeft: "8px",
                            color: selectedValue === "time_left_asc" ? "#108973" : "#17172E",
                            fontWeight: 400,
                            fontFamily: "Open Sans",
                            fontSize: "14px",
                          }}
                    ...
                    label={
                      <Box display="flex" alignItems="center">
                        ...
                        <span
                          style={{
                            marginLeft: "8px",
                            color: selectedValue === "upside_left_desc" ? "#108973" : "#17172E",
                            fontWeight: 400,
                            fontFamily: "Open Sans",
                            fontSize: "14px",
                          }}
                    ...
                    label={
                      <Box display="flex" alignItems="center">
                        ...
                        <span
                          style={{
                            marginLeft: "8px",
                            color: selectedValue === "upside_left_asc" ? "#108973" : "#17172E",
                            fontWeight: 400,
                            fontFamily: "Open Sans",
                            fontSize: "14px",
                          }}
