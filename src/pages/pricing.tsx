    ...
    return (
        ...
        <video className=" h-full w-full object-cover z-40 pointer-events-none" src="/pricing/hero_bg.webm" autoPlay muted loop></video>
            ...
            <div className="relative ">
                <div
                    className="relative  w-[min(1280px,calc(100%-32px))] min-w-[328px] mx-auto max-h-[700px]  md:max-h-[950px]">
                    ...
                    <div
                        className=" md:mt-14 grid grid-cols-2 grid-rows-6 md:grid-rows-[auto] mt-[30px] gap-4 md:grid-cols-1 place-items-center max-h-full">
                        <UserTypeDesktopCard/>
            ...
            <div
                className="bg-[linear-gradient(0deg,white_97.6%,transparent)] md:bg-[linear-gradient(0deg,white_95%,transparent)]">
                ...
                <div id="testimonials" className=" py-[60px] bg-gray-100 relative ">
                    <div className=" absolute top-[-5%] md:top-[-10%] w-screen">
                        <svg className=" w-full h-full" viewBox="0 0 1440 236" fill="none"
