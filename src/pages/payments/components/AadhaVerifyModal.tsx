import { postAadharOtp } from '@/api/payment'
...
export default function AadhaVerifyModal({aadhar,requestId,setDisplayModal}:{aadhar:string;requestId:string;setDisplayModal:React.Dispatch<React.SetStateAction<string>>}) {
  ...
  const handleVerifyAadharOtp = async()=>{
    try{
      ...
      let address = Object.values(res?.address).join(", ")
    ...
    <div className=" flex flex-col md:flex-row gap-6">
      ...
      <div className=" flex flex-col gap-y-6">
        ...
        <div className=" md:mt-4">
          ...
          <p className=" text-2xs mt-2"> Haven’t received the OTP?</p>
        ...
        <Button disabled={otp.length!== 6 || !consetGranted} onClick={handleVerifyAadharOtp} className=" ml-auto" variant={ButtonVariant.primary}>
          <p>Verify OTP</p>
        </Button>
      </div>
