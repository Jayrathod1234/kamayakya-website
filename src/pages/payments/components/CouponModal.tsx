...
export default function CouponModal() {
  ...
  return (
    <Dialog>
      ...
      <DialogContent closeClassName=" opacity-100 right-[-0.8rem] top-[-1rem] !bg-white"  className="open_sans gap-0 max-h-[80dvh] min-h-[500px] !rounded-[20px] max-w-[358px] p-6 flex flex-col">
