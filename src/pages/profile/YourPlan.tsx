      ...
      <div className=" mt-3 bg-white rounded-xl">
        <div>
          <div className=" bg-[linear-gradient(89.92deg,rgba(255,205,143,0.2)_-28.84%,rgba(255,225,190,0.2)_107.35%)] p-[6px] flex items-center justify-center">
            <p className="m-0 text-orange-700 font-medium text-sm">Member since May 2024</p>
          </div>
          <div className=" p-6">
            <h4 className=" font-bold text-lg m-0">VIP-Main Board</h4>
            <p className="m-0 text-[#667085]">
              Ideal for semi-pro and professional retail investors focused on Main Board stocks with flexible investment
              amounts.
            </p>
            <div className=" mt-6">
              <div className=" grid grid-cols-2 rounded-lg border border-[#F0F1F2]">
                <div className="col-span-1 border-r border-r-[#F0F1F2]">
                  <DateSection dateLabel={"Start Date"} date={"25 Feb 2024"} />
                </div>
                <div className=" col-start-2 ">
                  <DateSection dateLabel={"End Date"} date={"25 Feb 2025"} />
                </div>
        ...
        <div className=" p-6 flex items-center justify-between bg-[#FFFBFA]">
          <div>
            <p className=" font-medium text-md text-black m-0">Renew / Upgrade Plan</p>
            <p className=" text-error-500 text-sm flex items-center gap-x-2 mt-[6px]">
              ...
              Your subscription will expire in <span className=" font-semibold">30 days</span>. Please renew or upgrade
              your plan to continue enjoying our services.
            </p>
          </div>
          <div>
            <ChevronRight />
