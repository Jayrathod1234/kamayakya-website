...
export const useStockProgressBar = (emblaApi?: EmblaCarouselType, target) => {
  ...
  useEffect(() => {
    ...
    const handleEmblaInit = () => {
      console.log("Embla initialized, calculating distance...");
      calculateDistance();
    };
    ...
    // return ()=> emblaApi.off("init", handleEmblaInit).off("resize", handleResizeOrScroll).off("scroll", handleResizeOrScroll);
