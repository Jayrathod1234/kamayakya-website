		...
		>
			...
			>
				...
				{isLoadingTrackRecord && (
                 ...
                 <p className=" text-sm md:text-lg text-gray-700 md:my-3 z-20">
                <MainSmeBoardModal
                  trigger={
				...
				<Box sx={{ display: 'flex', justifyContent: 'center', alignItems: 'center', mb: 5,mt:5 }}>
					...
					{showSME ? (
						<Grid item container gap={"20px"} justifyContent={"center"}>
							...
							{record.filter(stock => stock.stock_exchange === "BSE" || stock.stock_exchange === "NSE").map((item, index) => (
								// <ReactCardFlip
								// 	key={index}
																	...
																	28 ? (
																		...
																		>
																			{record[selectedCardIndex].stock_name}
																					...
																					{index === 0
																						? `Target ${record[selectedCardIndex]
															...
															/> */}
																		...
																		>
																			...
																			>
																				...
																				>
																					{target.target_action === "BUY" ||
																						...
																						? "ENTRY"
																						: "HOLD"}{" "}
																					{`PRICE ${record[selectedCardIndex].stock_targets
																							.length - index
																						}`}
																				</Text>
																			...
																			>
																				...
																				>
																					{/* EXIT PRICE */}
																					{`TARGET PRICE ${record[selectedCardIndex].stock_targets
																							.length - index
																						}`}
																				</Text>
																				<Text
						...
						{record.filter(stock => stock.stock_exchange === "BSE-SME" || stock.stock_exchange === "NSE-SME").map((item, index) => (
							// <ReactCardFlip
							// 	key={index}
							// 	isFlipped={flipStates[index]}
							// 	flipDirection="horizontal"
